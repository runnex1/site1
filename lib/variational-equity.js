...
/**
 * Hedge-neutral with deposits/withdrawals removed.
 * Prefer HN − cumulativeNetDeposits; else adjustedEquity + Var adjust.
 */
...
/**
 * PnL series: capital-neutral hedge-neutral, rebased so the first point is $0.
 * Built from the same HN level as the Hedge-neutral chart.
 */
function rebaseHedgeNeutralSeriesToPnl(points) {
