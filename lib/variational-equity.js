 ...
 * price moves cancel. Remaining move is entry slip, funding, fees, and true basis.
 */
 ...
 * Add Var MTM marked at the SAME tracked venue mark so price cancels.
 */
function variationalOpenEquityAdjust(pairs, isVariationalPair) {
  ...
  for (const pair of pairs || []) {
    ...
    // Fallback when tracked mark missing: stored Var-leg uPnL.
 ...
 * sameMark:false keeps Variational listing mark (pair-card display).
 */
