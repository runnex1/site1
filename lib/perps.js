...
function attachPairFundingMeta(pair, base, venueA, venueB, paymentSources, fillSources) {
  pair.fundingByRange = {
...
function buildPairedAnalysis({
  ...
  function pushHlNadoPair(base, hl, na) {
    ...
    attachPairFundingMeta(paired[paired.length - 1], base, 'hyperliquid', 'nado', paymentSources, fillSources);
  ...
  function pushCrossPair(base, pairType, pairLabel, legA, legB, venueA, venueB, fundingA, fundingB, feesA, feesB, spreadKey) {
    ...
    attachPairFundingMeta(paired[paired.length - 1], base, venueA, venueB, paymentSources, fillSources);
