...
async function fetchPerpsDashboard(wallets) {
  ...
  const [
    ...
    withTimeout(fetchHyperliquidRates(), PERPS_CORE_FETCH_TIMEOUT_MS, 'Hyperliquid rates'),
    withTimeout(fetchNadoRates(), PERPS_CORE_FETCH_TIMEOUT_MS, 'NADO rates'),
    withTimeout(fetchHyperliquidCapitalFlows(hlWallet), PERPS_CORE_FETCH_TIMEOUT_MS, 'Hyperliquid capital flows'),
    withTimeout(fetchNadoCapitalFlows(nadoWallet), PERPS_CORE_FETCH_TIMEOUT_MS, 'NADO capital flows'),
