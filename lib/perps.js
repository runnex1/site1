  ...
  return (rows || [])
    ...
    .map(p => {
      ...
      return {
        ...
        liquidationPx: grvtPx(p.liquidation_price ?? p.liquidationPrice ?? p.liq_price ?? p.liqPrice),
  ...
  return (rows || [])
    ...
    .map(p => {
      ...
      return {
        ...
        liquidationPx: parseFloat(p.liquidationPrice ?? p.liquidation_price ?? p.liquidationPx ?? p.liqPrice ?? 0),
  ...
  const positions = (state.assetPositions || [])
    ...
    .map(p => {
      ...
      return {
        ...
        markPx: parseFloat(pos.markPx || pos.oraclePx || pos.midPx || 0) || null,
        liquidationPx: parseFloat(pos.liquidationPx || pos.liqPx || 0) || null,
  ...
  const positions = openBalances
    .map(b => {
      ...
      return {
        ...
        markPx: oracle,
        liquidationPx: fromX18(b.liquidation_price_x18 ?? b.liquidationPriceX18 ?? b.liq_price_x18 ?? 0) || null,
