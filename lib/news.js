...
const DAILY_BRIEF_SOURCES = [
  ...
  { url: 'https://thedefiant.io/api/feed',                           label: 'The Defiant'     },
  { url: 'https://news.google.com/rss/search?q=site:theblock.co&hl=en-US&gl=US&ceid=US:en', label: 'The Block' },
  { url: 'https://protos.com/feed/',                                label: 'Protos'          },
