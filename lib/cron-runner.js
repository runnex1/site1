...
const JOBS = {
  predictionActivity: { everyMs: 60 * 1000, retryMs: 60 * 1000, maxRuntimeMs: 55 * 1000 },
  perpsLive: { everyMs: 60 * 1000, retryMs: 60 * 1000, maxRuntimeMs: 55 * 1000 },
  etfStockUpdate: { everyMs: 60 * 60 * 1000, retryMs: 10 * 60 * 1000, maxRuntimeMs: 55 * 1000 },
  fundingRates: { everyMs: 60 * 60 * 1000, minute: 2, retryMs: 5 * 60 * 1000, maxRuntimeMs: 55 * 1000 },
  loopsSync: { everyMs: 5 * 60 * 1000, retryMs: 5 * 60 * 1000, maxRuntimeMs: 55 * 1000 },
  equitySnapshot: { everyMs: 4 * 60 * 60 * 1000, retryMs: 15 * 60 * 1000, maxRuntimeMs: 55 * 1000 },
  checkAlerts: { everyMs: 5 * 60 * 1000, retryMs: 5 * 60 * 1000, maxRuntimeMs: 55 * 1000 },
};
