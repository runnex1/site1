...
function loopHistoryCapitalEvent(prev, curr) {
  ...
  const prevNet = num(prev.netValue, num(prev.totalSupplied, 0) - num(prev.totalBorrowed, 0));
  const currNet = num(curr.netValue, num(curr.totalSupplied, 0) - num(curr.totalBorrowed, 0));
