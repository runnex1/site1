/**
 * Variational funding settlement clock.
 *
 * Variational's public stats API exposes funding_interval_s but not next settlement time.
 * Per Variational docs, the calculation window matches Bybit when listed there, else Binance,
 * else 1h. We resolve the live nextFundingTime from that reference perp market.
 */
