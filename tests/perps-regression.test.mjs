...
assert.match(indexHtml, /function renderWatcherPmWalletRows\(/, 'Wallet Watchlist must render PM wallet rows separately');
assert.match(indexHtml, /watcherPmWalletRows/, 'Wallet Watchlist must include PM wallet list container');
