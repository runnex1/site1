...
assert.match(indexHtml, /vault_news_cache_v8/, 'news cache key must bump when DeFi section feed filters change');
assert.match(newsJs, /label: 'The Block', type: 'defi'/, 'The Block must be a defi source via Google News site feed');
assert.match(newsJs, /site:theblock\.co\+DeFi/, 'The Block RSS must use Google News DeFi site feed');
...
assert.doesNotMatch(newsJs, /site:theblock\.co&hl=en-US/, 'The Block must not use the unfiltered all-site Google News query');
